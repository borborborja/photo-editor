...
android {
    ...
    buildTypes {
        ...
        create("preview") {
            ...
            // continues to consume the unsigned release artifact above. CI
            // supplies a persistent key through encrypted repository secrets,
            // so Preview users can update without uninstalling.
